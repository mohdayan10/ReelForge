...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      // Type definition for DeviceMotionEvent with requestPermission method (iOS 13+)
      const DeviceMotionEventConstructor = window.DeviceMotionEvent as unknown as {
        ...
        <div className="pc-inside">
          ...
          <div className="pc-content pc-header-content">
            <div className="pc-details">
              <h3>{name}</h3>
              <p>{title}</p>
              {oneLiner && <div className="pc-one-liner">{oneLiner}</div>}
            </div>
          </div>
